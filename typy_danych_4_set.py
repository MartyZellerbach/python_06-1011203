...
print(
    zbior)  # {33, 66, 777, 11, 44, 22, 55}  - nie zachowuje kolejnosci przy dodawaniu elementu, zmienil sie rozniez nawias na klamerkowy
...
print(
    zbior | zbior2)  # suma dwóch zbiorów {999, 11, 44, 18, 52, 22, 667, 62} z uwzgledniemiem ze jak powtarzaja sie dane to pokaze tylko raz
